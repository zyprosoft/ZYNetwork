...
- (void)addDebugMoudle
{
    TVGDebugModel *item = [TVGDebugModel debugModelWithTitle:@"Simple Demo" withClassName:@"DemoViewController"];
    TVGDebugSectionInfo *sectionInfo = [TVGDebugSectionInfo debugSectionInfoWithTitle:@"Simple Demo" withTestsArra:@[item]];
